...
export default function PushToggle() {
  const { estado, trabajando, activar, desactivar } = usePushNotifications();
  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-tinta/10 bg-white px-4 py-3">
